...
class BelgeNotlariWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        # Yükseklik dışarıdan (belge alt paneli) yönetilir; metin kutuları
        # kapsayıcı yüksekliğine göre genişlesin diye sabit üst sınır yok.
        self.txt_note1.setMinimumHeight(48)
        ...
        self.txt_note2.setMinimumHeight(48)
