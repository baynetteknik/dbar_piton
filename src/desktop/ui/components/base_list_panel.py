"""
ToyaUI — BaseListPanelWidget
3 panelli liste ekranı temel sınıfı.
Sol panel (filtre/aksiyon), orta panel (tablo), sağ panel (işlemler).

Eski adı: DIA3PanelBaseWidget (dia_3_panel_base.py)
DİA ticari markasından bağımsız hale getirildi.
"""
...
class BaseListPanelWidget(QWidget):
    """
    ToyaUI — 3 Panelli Liste Ekranı Temel Sınıfı

    Tüm liste ekranları bu sınıftan türer.
    Sol panel (EdgeTriggeredPanel) + Orta tablo + Sağ panel (EdgeTriggeredPanel)

    Kullanım:
        class TeklifListesi(BaseListPanelWidget):
    ...
    def init_base_ui(self) -> None:
        ...
        # ─────────────────────────────────────────
        # 1. SOL PANEL — Filtre / Aksiyon Butonları
        # ─────────────────────────────────────────
        ...
        # ─────────────────────────────────────────
        # 2. ORTA PANEL — FilterableTableView
        # ─────────────────────────────────────────
        self.center_container = QWidget()
        self.center_container.setObjectName("BaseListPanelCenter")
        ...
        # Üst bar (sayfa başlığı, özel buton vs.)
        ...
        # ─────────────────────────────────────────
        # 3. SAĞ PANEL — Export / Hızlı İşlemler
        # ─────────────────────────────────────────
    ...
    def setup_left_panel_content(self, container: QFrame, layout: QVBoxLayout) -> None:
        """Sol paneli doldur. Alt sınıflarda override edilmeli."""
    ...
    def setup_right_panel_content(self, container: QFrame, layout: QVBoxLayout) -> None:
        """Sağ paneli doldur. Alt sınıflarda override edilmeli."""
    ...
    def load_data(self) -> None:
        """Veriyi tabloya yükler. Alt sınıflarda override edilmeli."""
        pass

    def refresh_table(self) -> None:
        """Tabloyu yeniler. load_data ile aynı işlevi görür."""
        self.load_data()
