...
class MusteriYonetimiWidget(ThreePanelBaseWidget):
    ...
    def init_base_ui(self):
        ...
        btn_new.setObjectName("act.add.001")
        btn_new.setToolTip("[act.add.001] Yeni Cari Kart Ekle (F3)")
        ...
        btn_edit.setObjectName("act.edt.001")
        btn_edit.setToolTip("[act.edt.001] Seçili Cari Kartı Değiştir (F4)")
        ...
        btn_copy.setObjectName("act.dup.001")
        btn_copy.setToolTip("[act.dup.001] Cari Kartı Kopyala")
        btn_copy.setStyleSheet(self.toolbar_btn_style())
        btn_copy.clicked.connect(self.copy_customer)

        btn_delete = QPushButton("❌ Sil (Del)")
        btn_delete.setObjectName("act.del.001")
        btn_delete.setToolTip("[act.del.001] Seçili Cari Kartı Sil (Del)")
        btn_delete.setStyleSheet(self.toolbar_btn_style())
        btn_delete.clicked.connect(self.delete_customer)
        
        btn_toggle_status = QPushButton("🔌 Durum (Aktif/Pasif)")
        btn_toggle_status.setObjectName("act.tog.001")
        btn_toggle_status.setToolTip("[act.tog.001] Cariyi Aktif/Pasif Yap")
        ...
        btn_print.setObjectName("act.prn.001")
        btn_print.setToolTip("[act.prn.001] Cari Listesini Yazdır / PDF")
